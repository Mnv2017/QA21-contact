...
public class HelperBase {
    ...
    public String takeScreenshot() {
        File tmp = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);// сначала сохраняем во временный файл
        File screenshot = new File("screenshot/screen-" + System.currentTimeMillis() + ".png");// создаем новый пустой файл
        // перемещаем данные из tmp в screenshot
        try {
